  ...
  return (
    <div className='nav-container'>
        ...
        <div className="hamburger-container" onClick={showMenu}>
            {clickedState ? <ImCross className='ham-bar' /> : <FaEquals className='ham-bar' />}
        </div>
        <div className='nav-item-list'>
            <div className='github-star-repo-container nav-item' onClick={() => {setClickState(!clickedState)}}>
                {clickedState ? <FaStar className='star-repo-icon'/> : <FaRegStar className='star-repo-icon'/>}
